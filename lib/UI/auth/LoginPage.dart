...
import 'package:groceryproject/UI/auth/ForgotPassword.dart';
import 'package:groceryproject/UI/auth/RegisterPage.dart';
import 'package:groceryproject/UI/auth/authStack.dart';
import 'package:groceryproject/UI/pages/HomeScreen.dart';
import 'package:groceryproject/widgets/MyTextFormField.dart';
              ...
              Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Image.asset('img/Vector.png',width: 40,),
                      Image.asset('img/google.png',width: 40,),
                    ],
                  ),
                  SizedBox(height: 2.h),
                  Row(
